...
import net.octacomm.sample.orm.data.JpaTeamService;
...
@EnableJpaRepositories(transactionManagerRef = "txManager", basePackageClasses = { TeamRepository.class })
@ComponentScan(basePackageClasses = { JpaTeamService.class })
